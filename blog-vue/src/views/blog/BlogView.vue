      ...
      <el-main>
        ...
        <div class="me-view-card">
          ...
          <div class="me-view-tag">
            ...
            <el-button @click="tagOrCategory('tag', t.id)" size="mini" type="primary" v-for="t in article.tagList" :key="t.id" round plain>{{t.tagName}}</el-button>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      publishComment() {
        ...
        {
          that.$message({type: 'warning', message: '前先登陆哦', showClose: true})
          return;
        }
